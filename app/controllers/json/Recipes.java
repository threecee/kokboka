...
public class Recipes extends ParentControllerCRUD {
    ...
    public static void getRecipe(Long id) {
        Recipe recipe = Recipe.findById(id);
         JSONSerializer serializer = new JSONSerializer().include("tags").include("ingredients").exclude("author");
        renderFlex(recipe, serializer);
    }
    public static void getRecipes() {
        List<Recipe> recipes = Recipe.findAll();
         JSONSerializer serializer = new JSONSerializer().include("tags").include("ingredients").exclude("author");
        renderFlex(recipes, serializer);
    }
